                    ...
                    <div id="bank-tab-content-${key}-media" class="bank-tab-content" style="${activeSubTab === 'media' ? '' : 'display: none;'}">
                        ...
                        <div class="bank-deletion-settings-row">
                            ...
                            <div class="bank-deletion-settings-control">
                                <div style="display: flex; background: rgba(0, 0, 0, 0.22); border: 1px solid rgba(255, 255, 255, 0.05); padding: 3px; border-radius: 10px; width: 100%; box-sizing: border-box; justify-content: space-between; align-items: center; gap: 4px;">
