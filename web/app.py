...
from web.routers import (
    dashboard, lines, sessions, media, banks, codes, messages, users, settings, stats, websocket, methods
)
...
app.include_router(methods.router, dependencies=[admin_dependency])
