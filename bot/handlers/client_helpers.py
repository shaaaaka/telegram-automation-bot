...
class RegistrationStates(StatesGroup):
    ...
    pumb_rebind_card_details = State()
    pumb_rebind_anketa_screenshot = State()
    pumb_rebind_phone_change = State()
    pumb_rebind_pincode = State()
    pumb_rebind_deletion_screenshot = State()
