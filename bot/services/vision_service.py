        ...
        content = [
            {
                ...
                "text": (
                    ...
                    f"2. УСПІШНЕ ВИДАЛЕННЯ (Поверни ТАК): \n"
                    f"   - ВІДЕО-ДОКАЗ: Якщо це відеозапис і на відео видно процес затискання іконки додатку {bank_name or ''}, вибір меню «Видалити», перетягування до кошика або зникнення додатку після підтвердження — видалення ПІДТВЕРДЖЕНО! Поверни ТАК.\n"
                    f"   - МАГАЗИН ДОДАТКІВ: Якщо на екрані App Store або Play Market видно саме {exact_bank} із кнопкою для встановлення («Завантажити», «Встановити», «Get», кнопка хмарки зі стрілкою) — видалення ПІДТВЕРДЖЕНО! Поверни ТАК.\n"
                    f"3. НЕПРИЙНЯТНИЙ ДОКАЗ (Поверни НІ):\n"
                    f"   - СТАТИЧНИЙ скріншот робочого столу без відеозапису процесу видалення — Поверни НІ та вкажи: «Будь ласка, надішліть скріншот з App Store/Play Market із кнопкою завантаження або відео видалення.»\n"
                    f"   - Додаток все ще встановлено (видно кнопку «Відкрити», «Оновити» або додаток працює) — Поверни НІ та вкажи: «Додаток все ще встановлено на телефоні.»\n"
                    f"4. В інших випадках, коли видалення невидно або надіслано незрозумілий файли — поверни НІ та вкажи причину.\n\n"
